...
nedge1 = cat(3,edge{:,in2});

zedge1 = zscore3D(nedge1);
% zedge1 = nedge1;


load cameg_ConnTeens
nedge2 = cat(3,edge{:,in2});

zedge2 = zscore3D(nedge2);
% zedge2 = nedge2;

zedge = cat(3, zedge1, zedge2);

figure, imagesc(mean(zedge,3))
colorbar

save cameg_NBS_conn zedge

% Design mat
design =  zeros(size(zedge,3),2);
design(1:15,1)   = 1; % Kids
design(16:end,2) = 1; % Teens
