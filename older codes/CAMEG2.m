...
f16 = uimenu(f1,'Label','ROI detection');
uimenu(f16,'Label','by cortical thickness values', ...
    'Callback','cameg_datapre_ROIdet_CT');
uimenu(f16,'Label','by power spectral density (PSD) of sources', ...
    'Callback','cameg_datapre_ROIdet_PSD');
f17 = uimenu(f1,'Label','number of ROIs (update)',...
...
f35 = uimenu(f3,'Label','Conn (flux)', ...
    'Callback','cameg_ConnF');
f36 = uimenu(f3,'Label','PSD (sources)', ...
    'Callback','cameg_psdVis');
